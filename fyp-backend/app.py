...
SPOTIFY_CLIENT_ID = os.getenv(
    "SPOTIFY_CLIENT_ID",
    "d080e4de4c7e42f096579071f7afa910"
)
SPOTIFY_CLIENT_SECRET = os.getenv(
    "SPOTIFY_CLIENT_SECRET",
    "c7cd31acb816407ca8db500f562dae73"
)
    ...
    return [
        {
            "label": l,
            "count": c,
            "avg_conf": float(round(np.mean(confs[l]), 3))
        }
...
def generate_long_story(objects, emotion, keyword=None, max_words=130):
    ...
    try:
        prompt = (
            ...
            "Make it descriptive, with vivid sensory imagery, "
            "realistic tone, and a reflective ending."
        )
...
def get_status():
    return jsonify({
        ...
        "result": {
            ...
            "recommended_song": final_result.get(
                "recommended_song",
